...
export declare function findElement(
	css_selector: string,
): Promise<string | undefined>;
export declare function elementClick(element_id: string): Promise<boolean>;
export declare function elementSendKeys(
	element_id: string,
	text: string,
): Promise<boolean>;
export declare function takeElementScreenshot(
	element_id: string,
	target_filepath: string,
): Promise<boolean>;
...
export declare function findElementFromElement(
	element_id: string,
	css_selector: string,
): Promise<string | undefined>;
export declare function findElementsFromElement(
	element_id: string,
	css_selector: string,
): Promise<string[] | undefined>;
export declare function getElementShadowRoot(
	element_id: string,
): Promise<string | undefined>;
export declare function findElementFromShadowRoot(
	shadow_root_id: string,
	css_selector: string,
): Promise<string | undefined>;
export declare function findElementsFromShadowRoot(
	shadow_root_id: string,
	css_selector: string,
): Promise<string[] | undefined>;
export declare function afterMicrotaskQueue(): Promise<void>;
